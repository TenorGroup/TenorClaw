...
if /i "%1"=="update" (
    echo openclaw is managed by TenorClaw ^(bundled version^).
    echo.
    echo To update openclaw, update TenorClaw:
    echo   Open TenorClaw ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=TenorClaw
...
if "%_USE_BUNDLED_NODE%"=="1" (
    ...
    "%~dp0..\..\TenorClaw.exe" "%OPENCLAW_ENTRY%" %*
)

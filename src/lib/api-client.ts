...
const GATEWAY_WS_DIAG_FLAG = 'tenorclaw:gateway-ws-diagnostic';
...
function shouldLogApiRequests(): boolean {
  try {
    return import.meta.env.DEV || window.localStorage.getItem('tenorclaw:api-log') === '1';
  } catch {

          ...
          <div>
            ...
            <div className="space-y-3 text-[14px] text-muted-foreground">
              ...
              <div className="flex gap-4 pt-3">
                <Button
                  variant="link"
                  className="h-auto p-0 text-[14px] text-foreground/70 underline hover:text-foreground font-medium"
                ...
                <Button
                  variant="link"
                  className="h-auto p-0 text-[14px] text-foreground/70 underline hover:text-foreground font-medium"
                  onClick={() => window.electron.openExternal('https://github.com/TenorGroup/TenorClaw')}
                >
                  {t('about.github')}
                </Button>
                <Button

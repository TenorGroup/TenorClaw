...
const selectClasses = 'h-[44px] w-full rounded-xl font-mono text-[13px] bg-muted dark:bg-muted border border-black/10 dark:border-white/10 focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:border-foreground/30 shadow-sm transition-all text-foreground px-3';
...
function AgentModelModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] bg-black/50 flex items-center justify-center p-4">
      <Card className="w-full max-w-xl rounded-3xl border-0 shadow-2xl bg-card dark:bg-card overflow-hidden">

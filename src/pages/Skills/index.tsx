            ...
            {!skill.isCore && (
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="password"
                  className="h-[44px] font-mono text-[13px] bg-muted dark:bg-muted border-black/10 dark:border-white/10 rounded-xl focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:border-foreground/30 shadow-sm transition-all text-foreground placeholder:text-foreground/40"
                />
                  ...
                  {envVars.map((env, index) => (
                    <div className="flex items-center gap-3" key={index}>
                      <Input
                        ...
                        className="flex-1 h-[40px] font-mono text-[13px] bg-muted dark:bg-muted border-black/10 dark:border-white/10 rounded-xl focus-visible:ring-2 focus-visible:ring-ring/50 shadow-sm text-foreground"

...
const inputClasses = 'h-[44px] rounded-xl font-mono text-[13px] bg-muted dark:bg-muted border-black/10 dark:border-white/10 focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:border-foreground/30 shadow-sm transition-all text-foreground placeholder:text-foreground/40';
    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-muted-foreground bg-black/5 dark:bg-white/5 rounded-3xl border border-transparent border-dashed">
          ...
          <Button onClick={() => setShowAddDialog(true)} className="rounded-full px-6 h-10 bg-primary hover:bg-primary/90 text-white">
            <Plus className="h-4 w-4 mr-2" />
...
function ProviderCard({
  ...
  const currentInputClasses = isDefault
    ? "h-[40px] rounded-xl font-mono text-[13px] bg-white dark:bg-card border-black/10 dark:border-white/10 focus-visible:ring-2 focus-visible:ring-ring/50 shadow-sm"
    : inputClasses;
          ...
          {effectiveDocsUrl && (
            <div className="flex justify-end -mt-2 mb-2">
              <a
                ...
                className="text-[12px] text-foreground/70 underline hover:text-foreground font-medium inline-flex items-center gap-1"
              >
              ...
              <div className="space-y-3 pt-2">
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className={isDefault
                      ? "min-h-24 w-full rounded-xl border border-black/10 dark:border-white/10 bg-white dark:bg-card px-3 py-2 text-[13px] font-mono outline-none focus-visible:ring-2 focus-visible:ring-ring/50 shadow-sm"
                      : "min-h-24 w-full rounded-xl border border-black/10 dark:border-white/10 bg-muted dark:bg-muted px-3 py-2 text-[13px] font-mono outline-none focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:border-foreground/30 shadow-sm transition-all text-foreground placeholder:text-foreground/40"}
                  />
                  <p className="text-[12px] text-muted-foreground">
                ...
                <div className="space-y-2 pt-1">
                  ...
                  {fallbackOptions.length === 0 ? (
                    ...
                    <div className={cn("space-y-2 rounded-xl border border-black/10 dark:border-white/10 p-3 shadow-sm", isDefault ? "bg-white dark:bg-card" : "bg-muted dark:bg-muted")}>
                      {fallbackOptions.map((candidate) => (
                        <label key={candidate.account.id} className="flex items-center gap-3 text-[13px] cursor-pointer group/label">
                          <input
                            ...
                            className="rounded border-black/20 dark:border-white/20 text-primary focus:ring-ring/50"
                          />
            ...
            {typeInfo?.apiKeyUrl && (
              <div className="flex justify-start">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[13px] text-foreground/70 underline hover:text-foreground flex items-center gap-1"
                  tabIndex={-1}
                >
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3 p-4 rounded-2xl bg-white dark:bg-card border border-black/5 dark:border-white/5 shadow-sm">
                ...
                <div>
                  ...
                  className="text-[13px] text-foreground/70 underline hover:text-foreground font-medium"
                >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {typeInfo?.apiKeyUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-[13px] text-foreground/70 underline hover:text-foreground font-medium flex items-center gap-1"
                          tabIndex={-1}
                        >
                          {t('aiProviders.oauth.getApiKey')} <ExternalLink className="h-3 w-3" />
                        </a>
                ...
                {useOAuthFlow && (
                  <div className="space-y-4 pt-2">
                    <div className="rounded-xl bg-muted border border-border p-5 text-center">
                      <p className="text-[13px] font-medium text-muted-foreground dark:text-muted-foreground mb-4 block">
              ...
              <div className="flex justify-end gap-3">
                <Button
                  onClick={handleAdd}
                  className={cn("rounded-full px-8 h-[42px] text-[13px] font-semibold bg-primary hover:bg-primary/90 text-white shadow-sm", useOAuthFlow && "hidden")}

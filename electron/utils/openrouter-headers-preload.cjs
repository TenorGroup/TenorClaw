 ...
 * "openrouter.ai" carries the TenorClaw app-attribution headers.
 *
...
(function () {
  ...
  if (globalThis.__tenorclawFetchPatched) return;
  globalThis.__tenorclawFetchPatched = true;

  globalThis.fetch = function tenorclawFetch(input, init) {
    var url =
